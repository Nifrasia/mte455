...
public class StructureManager : MonoBehaviour
{
    ...
    private Camera cam;
        ...
        [SerializeField] private List<GameObject> roadGreenTilesList = new

    List<GameObject>(); //list contains green tiles
    ...
    private void PlaceBuilding()
    {
        ...
        GameObject structureObj = Instantiate(curBuildingPrefab, curCursorPos, Quaternion.identity, buildingParent.transform);
    ...
    {
        if (buildingCursor != null && buildingCursor.tag == "Road") return;
